#include<iostream>
#include <num/base/thread_poll.h>
#include<thread>
#include<memory>
#include<vector>
#include <num/base/num_sort.h>
#include <num/base/functions.h>
/*
测试说明： split -l 10000000 out.txt -d -a 2 data_  将原数据分割
保存在data文件夹下
...
{ 
  ...
  std::string str;
  num:: get_all_file_name(datas,"data1");
...
std::cout<<*iter<<std::endl;
  ...
  sorts.push_back( new num::num_sort(("data1/"+*iter),("result_data/result_"+(*iter))));
